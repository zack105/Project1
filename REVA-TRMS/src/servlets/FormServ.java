	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String cType = "";
		 try {
		        ...
		        System.out.println("course type: "+ items.get(0).getString());
		        System.out.println("grade form " + items.get(1).getString());
		        System.out.println("descript " + items.get(2).getString());
		        System.out.println("date" + items.get(3).getString()+"enddate");
		        System.out.println("lenth " +items.get(4).getString());
		        System.out.println("loc " + items.get(5).getString());
		        
		        System.out.println("cost " + items.get(6).getString());
		        System.out.println("just " +items.get(7).getString());
		        ...
		        for (int i = 0; i < items.size(); i++) {
		            if (!items.get(i).isFormField()) {
				        ...
				        System.out.println(items.get(i).getString()+":"+SAVED_DIR + "\\" + name);
...
//		                InputStream fileContent = item.getInputStream();
        	...
        	System.out.println("this is teh " + input);
    		try{
